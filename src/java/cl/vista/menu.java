        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (user.getRol()) {
                case "ADMINISTRADOR":
                    ...
                    out.println("<tr><td>1</td><td><a href='ingvehiculo.view'>Ingresas un nuevo vehiculo</a></td>");
                ...
                case "EMPLEADO":
                    ...
                    out.println("<tr><td>2</td><td><a href='vervehiculosdisp.view'>Ver vehiculos disponibles</a></td>");
                    out.println("</table>");
                    out.println("<br/><br/>");
                    out.println("<a href='cerrar.do'>Cerrar Sesion</a>");
                    out.println("</center>");
